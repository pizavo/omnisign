...
editor. In the **Signature** panel, open a signature's or timestamp's
[full certificate view](validation.mdx#the-full-certificate-view), select a certificate, and click the
