...
class CertificatesList : CliktCommand(name = "list"), KoinComponent {
     ...
     */
    private fun printCertificatesTable(certificates: List<CertificateInfo>) {
...
/**
 * Create the certificates command with all subcommands registered.
 */
fun certificatesCommand() = Certificates().subcommands(
    CertificatesList()
)
