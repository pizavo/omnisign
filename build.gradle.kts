...
tasks.register("generateThirdPartyNotices") {
    ...
    doLast {
        ...
        if (verifyOnly.get()) {
            ...
            logger.lifecycle("Wrote ${noticeFile.name} and ${creditsFile.name}: ${usedComponents.size} components ($perSurface), $totalArtifacts artifacts, ${noticeTexts.size} attribution notices.")
        }
    }
}
